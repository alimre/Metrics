...
def merged_date(link):
    """
    ----------------
    Merged Date (MRGDD)
    ----------------
    The date on which the pull request was merged.
    """
    ...
    def action():
        try:
            ...
            # return pull.raw_data["merged_at"]
            return datetime.datetime.strptime(pull.raw_data["merged_at"], "%Y-%m-%dT%H:%M:%SZ")
